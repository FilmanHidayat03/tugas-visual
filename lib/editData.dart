...
class _EditDataState extends State<EditData> {
  ...
  void initState() {
    ...
    posisiController = new TextEditingController(text: widget.list[widget.index]['posisi']);
    gajiController = new TextEditingController(text: widget.list[widget.index]['gaji']);
    super.initState();
  }
